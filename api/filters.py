...
class AppointmentFilter(filters.FilterSet):
    start_date = filters.DateFilter(field_name='start_time__date', lookup_expr='gte', label='Start Date')
    end_date = filters.DateFilter(field_name='end_time__date', lookup_expr='lte', label='End Date')
